...
export default function Header({ searchTerm, setSearchTerm, pokemonCount, cardCount, isLoading }: Props) {
        ...
        <div className="flex items-center justify-between gap-4 mb-4 sm:mb-6">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs sm:text-sm text-red-200/80 mt-1 font-medium truncate">Collection complète de cartes</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
            {!isLoading && (
              <div className="hidden xl:block">
                <Stats pokemonCount={pokemonCount} cardCount={cardCount} />
              </div>
            )}
              ...
              <div className="flex items-center gap-2 sm:gap-3">
                <Link
                  ...
                  className="px-3 sm:px-5 py-2.5
                           bg-slate-800/90 hover:bg-slate-700/90
                           rounded-xl font-medium text-white text-sm sm:text-base
                ...
                <Link
                  href="/register"
                  className="hidden sm:block px-5 py-2.5
