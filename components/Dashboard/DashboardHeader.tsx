        ...
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 sm:gap-4 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-2xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-yellow-500 to-orange-400 drop-shadow-lg flex items-center gap-3">
                <TrendingUp className="w-6 h-6 sm:w-8 sm:h-8 text-amber-400" />
                Dashboard
              </h1>
              <p className="text-xs sm:text-sm text-red-200/80 mt-1 font-medium">
